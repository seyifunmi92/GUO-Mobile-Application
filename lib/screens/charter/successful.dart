...
class CharterSuccess extends StatefulWidget {
  const CharterSuccess({super.key});

  @override
  State<CharterSuccess> createState() => _CharterSuccessState();
}

class _CharterSuccessState extends State<CharterSuccess> {
  @override
    ...
    return Scaffold(
      ...
      body: Column(children: [
        ...
        Row(
          ...
          children: [
            dText("Request Successful", mqHeight(context, .04),
